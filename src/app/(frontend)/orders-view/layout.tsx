      ...
      <Table className="w-full">
        <TableHeader>
          <TableRow className="bg-muted/60 sticky z-10 backdrop-blur-sm">
            ...
            <TableHead className="font-semibold text-foreground text-center">Uczestnicy</TableHead>
            ...
            >
              ...
              <TableCell className="text-center">
                {(() => {
                  ...
                  const carts = Array.isArray((order as any).carts)
                    ? ((order as any).carts as any[])
                    : []
                  const hasCart = !!viewerClerkId && carts.some((c) => c?.userId === viewerClerkId)
                  const badge = isMine
                    ? {
                        text: 'Moje Ogłoszenie',
